...
| `repository-path` | The path to a local git repository to get the git ref info from. Mutually exclusive with inputs.repository | This or `inputs.repository` required | N/A | `"/opt/some/git/repo"` |
